...
xml_current_scene_tag = ET.SubElement(xml_current_act_tag, "div", attrib=new_scene_dict)
...
while current_tag.find_next(target_tag_list):
    ...
    if do_cast_list and now_cast_list and current_tag.name == "div":
    ...
    if current_tag.name == "p":
        ...
        if current_tag["class"][0] == "text-regular" or current_tag["class"][0] == "text-continuation":
            ...
            for child_tag in current_tag.children:
                ...
                if child_tag.name == "i":
                    italic_flag = True
                    xml_current_phrase.text += " " + child_tag.text

                    # print("#############")
                    # print("fix <i>" + child_tag.text + "</i> \n", end="")
                    # print("#############")
            ...
            if speaker_name is not None:
                ...
                print("#############")
                print("Previous speaker:", previous_speaker_name)
